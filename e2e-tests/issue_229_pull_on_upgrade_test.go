...
func TestE2EIssue229PullOnUpgrade(t *testing.T) {
	t.Parallel()

	t.Run("stplr upgrade pull repos before upgrade", matrixSuite(COMMON_SYSTEMS, func(t *testing.T, r capytest.Runner) {
		defaultPrepare(t, r)
