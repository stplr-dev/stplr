...
const (
	REPO_NAME_FOR_E2E_TESTS               = "alr-repo"
	REPO_URL_FOR_E2E_TESTS                = "https://altlinux.space/stapler/repo-for-tests.git"
	REPO_URL_FOR_E2E_TESTS_SINGLE_PACKAGE = "https://altlinux.space/stapler/repo-for-tests-single-package.git"
)
