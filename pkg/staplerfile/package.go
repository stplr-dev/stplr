...
//go:generate bash -c "go run ../../generators/staplerfile-package && cd ../.. && make update-license"
...
type Package struct {
	...
	AppStream      *appstream.UpstreamComponent `xorm:"json 'appstream'" json:"appstream"`
